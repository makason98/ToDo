...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Admin Login <?php $__env->endSlot(); ?>

    <div class="text-center mb-8">
        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="ToDo" class="h-16 mx-auto mb-3">
...
<?php endif; ?>
    ...
    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700 text-center">
        <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-500 hover:text-red-500 hover:underline">
            Back to user login
        </a>
    </div>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH /home/tehnic/laravel/todo/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>