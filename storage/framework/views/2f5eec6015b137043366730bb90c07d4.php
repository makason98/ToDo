...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex h-[calc(100vh-64px)]" x-data="{ sidebarOpen: false }">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <?php echo $__env->make('tasks.partials.sidebar', ['currentPage' => 'dashboard'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </aside>
        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <div class="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
                ...
                ?>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo e($greeting); ?>, <?php echo e(auth()->user()->name); ?>!</h1>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo e($activeTasksCount); ?></p>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-lg <?php echo e($overdueCount > 0 ? 'bg-red-50 dark:bg-red-900/20' : 'bg-gray-50 dark:bg-gray-700'); ?> flex items-center justify-center">
                                <svg class="w-5 h-5 <?php echo e($overdueCount > 0 ? 'text-red-500' : 'text-gray-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                            </div>
                            <div>
                                <p class="text-2xl font-bold <?php echo e($overdueCount > 0 ? 'text-red-500' : 'text-gray-900 dark:text-gray-100'); ?>"><?php echo e($overdueCount); ?></p>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo e($completedToday); ?></p>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo e($streak); ?></p>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
                    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                        ...
                        <?php $maxCompleted = max($completedToday, $completedThisWeek, $completedThisMonth, 1); ?>
                        <div class="space-y-4">
                            <div>
                                <div class="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 mb-1">
                                    <span>Today</span><span><?php echo e($completedToday); ?> tasks</span>
                                </div>
                                <div class="w-full h-2.5 bg-gray-100 dark:bg-gray-700 rounded-full">
                                    <div class="h-2.5 bg-green-500 rounded-full" style="width: <?php echo e(($completedToday / $maxCompleted) * 100); ?>%"></div>
                                </div>
                            </div>
                            <div>
                                <div class="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 mb-1">
                                    <span>This week</span><span><?php echo e($completedThisWeek); ?> tasks</span>
                                </div>
                                <div class="w-full h-2.5 bg-gray-100 dark:bg-gray-700 rounded-full">
                                    <div class="h-2.5 bg-blue-500 rounded-full" style="width: <?php echo e(($completedThisWeek / $maxCompleted) * 100); ?>%"></div>
                                </div>
                            </div>
                            <div>
                                <div class="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 mb-1">
                                    <span>This month</span><span><?php echo e($completedThisMonth); ?> tasks</span>
                                </div>
                                <div class="w-full h-2.5 bg-gray-100 dark:bg-gray-700 rounded-full">
                                    <div class="h-2.5 bg-purple-500 rounded-full" style="width: <?php echo e(($completedThisMonth / $maxCompleted) * 100); ?>%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $upcomingTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <a href="<?php echo e(route('tasks.show', $task)); ?>" class="flex items-center gap-3 py-2.5 border-b border-gray-100 dark:border-gray-700 last:border-0 hover:bg-gray-50 dark:hover:bg-gray-700/50 -mx-2 px-2 rounded transition-colors">
                                <span class="w-2 h-2 rounded-full shrink-0 <?php echo e($task->priority === 'high' ? 'bg-red-400' : ($task->priority === 'low' ? 'bg-blue-400' : 'bg-orange-400')); ?>"></span>
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm text-gray-900 dark:text-gray-100 truncate"><?php echo e($task->title); ?></p>
                                </div>
                                <span class="text-xs shrink-0 <?php echo e($task->due_date->isPast() ? 'text-red-500' : 'text-gray-400 dark:text-gray-500'); ?>">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $recentActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-center gap-3 py-2 border-b border-gray-50 dark:border-gray-700 last:border-0">
                            <?php if($activity['type'] === 'completed'): ?>
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-gray-700 dark:text-gray-300 truncate">
                                    <span class="text-gray-400 dark:text-gray-500"><?php echo e($activity['type'] === 'completed' ? 'Completed' : 'Created'); ?></span>
                                    <?php echo e($activity['task']->title); ?>

                                </p>
                            </div>
                            <span class="text-xs text-gray-400 dark:text-gray-500 shrink-0"><?php echo e($activity['date']->diffForHumans()); ?></span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php endif; ?>
<?php /**PATH /home/tehnic/laravel/todo/resources/views/dashboard.blade.php ENDPATH**/ ?>