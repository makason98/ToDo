...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Admin Audit Log <?php $__env->endSlot(); ?>
    ...
    <div class="flex h-[calc(100vh-64px)]" x-data="{ sidebarOpen: false }">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <?php echo $__env->make('admin.partials.sidebar', ['currentPage' => 'audit'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </aside>
        ...
        <main class="flex-1 overflow-y-auto">
            <div class="sm:hidden flex items-center gap-3 p-4 border-b border-gray-200 dark:border-gray-700">
                ...
                <h1 class="text-lg font-bold text-gray-900 dark:text-gray-100">Audit</h1>
            </div>

            <div class="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
                <div class="mb-6">
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Admin audit log</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1"><?php echo e($logs->total()); ?> entries · who-did-what in the admin panel</p>
                </div>

                <form method="GET" action="<?php echo e(route('admin.audit.index')); ?>" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 mb-4">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-3">
                        ...
                        <div class="md:col-span-3">
                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Admin (name or email)</label>
                    ...
                    <div class="flex items-center gap-2 mt-3">
                        ...
                        <a href="<?php echo e(route('admin.audit.index')); ?>" class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400 hover:text-red-500 transition-colors">Clear</a>
                    </div>
                </form>
                        ...
                        <table class="w-full text-sm">
                            <thead class="bg-gray-50 dark:bg-gray-700/50 text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider">
                                <tr>
                                    ...
                                    <th class="text-center px-4 py-3 font-semibold">Admin</th>
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30">
                                        ...
                                        <td class="px-4 py-3 text-center">
                                            <span class="inline-flex items-center text-xs font-medium px-2.5 py-1 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded-full"><?php echo e($log->action); ?></span>
                                        </td>
                                        <td class="px-4 py-3 text-center text-gray-500 dark:text-gray-400 text-xs">
                                            <?php echo e(class_basename($log->subject_type)); ?><?php echo e($log->subject_id ? ' #' . $log->subject_id : ''); ?>

                                        </td>
                                        <td class="px-4 py-3 text-gray-700 dark:text-gray-300"><?php echo e($log->description); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr><td colspan="5" class="px-4 py-8 text-center text-sm text-gray-400 dark:text-gray-500">No admin activity matches your filters.</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
...
<?php endif; ?>
<?php /**PATH /home/tehnic/laravel/todo/resources/views/admin/audit/index.blade.php ENDPATH**/ ?>