...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Comments <?php $__env->endSlot(); ?>
    ...
    <div class="flex h-[calc(100vh-64px)]" x-data="{ sidebarOpen: false }">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <?php echo $__env->make('admin.partials.sidebar', ['currentPage' => 'comments'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </aside>
        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1"><?php echo e($comments->total()); ?> matching</p>
                </div>
                ...
                <form method="GET" action="<?php echo e(route('admin.comments.index')); ?>" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 mb-4">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-3">
                        <div class="md:col-span-6">
                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Search body</label>
                            <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Search comment text..."
                    ...
                    <div class="flex items-center gap-2 mt-3">
                        ...
                        <a href="<?php echo e(route('admin.comments.index')); ?>" class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400 hover:text-red-500 transition-colors">Clear</a>
                    </div>
                </form>
                        ...
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                <?php $__empty_1 = true; $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 <?php echo e($comment->trashed() ? 'opacity-60' : ''); ?>">
                                        ...
                                        <td class="px-4 py-3 text-center text-gray-500 dark:text-gray-400 whitespace-nowrap"><?php echo e($comment->created_at->format('M d, Y')); ?></td>
                                        <td class="px-4 py-3">
                                            <div class="flex items-center justify-center gap-2">
                                                <?php if($comment->trashed()): ?>
                                                    <form method="POST" action="<?php echo e(route('admin.comments.restore', $comment->id)); ?>">
                                                        <?php echo csrf_field(); ?>
                                                ...
                                                <?php else: ?>
                                                    <form method="POST" action="<?php echo e(route('admin.comments.destroy', $comment->id)); ?>" onsubmit="return confirm('Soft-delete this comment? It can be restored later.')">
                                                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /home/tehnic/laravel/todo/resources/views/admin/comments/index.blade.php ENDPATH**/ ?>