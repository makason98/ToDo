            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ $users->total() }} total</p>
                    </div>
                </div>
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                @forelse($users as $user)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30">
                                        <td class="px-4 py-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div class="flex items-center gap-2 flex-wrap">
                                                    ...
                                                    @if($user->isAdmin())
                                                        <span class="text-xs px-1.5 py-0.5 bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded">{{ $user->adminRoleLabel() }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-4 py-3 text-center text-gray-600 dark:text-gray-400">{{ $user->email }}</td>
                                        ...
                                        <td class="px-4 py-3 text-center text-gray-700 dark:text-gray-300 font-medium">{{ $user->tasks_count }}</td>
                                        <td class="px-4 py-3 text-center text-gray-500 dark:text-gray-400 whitespace-nowrap" title="{{ $user->created_at }}">
