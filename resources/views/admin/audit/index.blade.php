<x-admin-layout>
    <x-slot name="title">Admin Audit Log</x-slot>
    ...
    <div class="flex h-[calc(100vh-64px)]" x-data="{ sidebarOpen: false }">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            @include('admin.partials.sidebar', ['currentPage' => 'audit'])
        </aside>
        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ $logs->total() }} entries · who-did-what in the admin panel</p>
                </div>

                <form method="GET" action="{{ route('admin.audit.index') }}" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 mb-4">
                    ...
                    <div class="flex items-center gap-2 mt-3">
                        ...
                        <a href="{{ route('admin.audit.index') }}" class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400 hover:text-red-500 transition-colors">Clear</a>
                    </div>
                </form>
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                @forelse($logs as $log)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30">
                                        ...
                                        <td class="px-4 py-3 text-center">
                                            <span class="inline-flex items-center text-xs font-medium px-2.5 py-1 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded-full">{{ $log->action }}</span>
                                        </td>
